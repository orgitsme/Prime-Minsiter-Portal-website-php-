...
<head>
    ...
    <title>Contact - Pakistan Citizen's Portal</title>
    ...
    <div class="container">
        ...
        <main>
            <div class="form-container">
                <h2 id="hi">FORGOT YOUR PASSWORD ?</h2>
                <form>
              <h2>     <LABEl>Enter your Emial Address</LABEl><br></h2>
        ...
        <footer>
            ...
            <div class="social-media">
                ...
                <a href="#"><img src="images/whatsup.png" alt="whatsup"></a>
            </div>
